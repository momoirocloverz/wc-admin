    ...
    <div class="look-paired">
        <div class="look-paired-header">
            <div class="look-header-left">
                ...
                <el-button type="primary" class="look-header-btn" @click="searchDoctorList">搜索</el-button>
            </div>
        ...
        <div class="look-paired-content">
            <div class="look-paired-top">
                <span class="look-paired-title">标题：签约医生</span>
                <div class="look-time">
                    <span>日期：</span>
                    <el-date-picker type="year" v-model="yearInfo" placeholder="请选择随访日期" value-format="yyyy" @change="searchDoctorList" class="visit-time"></el-date-picker>
                </div>
                <span class="look-paired-title1">医生姓名：{{doctorName}}</span>
