  ...
  <div class="base_warp agricultural_products">
    <div class="search_content">
      <el-form ref="form" :model="formData">
        ...
        <el-col :span="6">
          <el-form-item label="发布类型" prop="issue_category">
...
import { CheckDetail, CheckList, DeleteMessage, AddMessage, EditMessage, issue_messageTypeList, issue_messageTypeAdd, issue_messageTypeDelete, auditIssue } from '@/api/information'
